...
### Changed
- **New initial layout**: checkerboard pattern on rows 1–6, alternating Red/Blue every two columns — both players start interleaved in the center of the board instead of on opposite sides
